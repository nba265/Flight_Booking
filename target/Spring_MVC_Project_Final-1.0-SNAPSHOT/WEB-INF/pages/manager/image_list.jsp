                                    ...
                                    <div class="card-body ">
                                        <div class="table-scrollable">
                                            <table class="table table-hover table-checkable order-column full-width" id="example4">
                                                ...
                                                <tbody>
                                                <input name="idService" value="${idService}" readonly hidden >
                                                <c:forEach items="${images.iterator()}" var="item" >
                                                    <tr class="odd gradeX">
                                                        <td class="center">${item.name}</td>
                                                        <td class="center"><img intrinsicsize="200x200"
                                                                                src="${pageContext.request.contextPath}/resources/images/${item.name}"
                                                                                alt="" width="200" height="200"></td>
                                                        <td class="center">
                                                            <a class="btn btn-tbl-delete btn-xs" href="deleteImage?id=${item.id}&idService=${idService}">
